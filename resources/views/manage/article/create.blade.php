											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="多个关键词之间用空格或者“,”隔开" name="keywords">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">摘要</label>
														<div class="col-md-8">
															<textarea  rows="3" class="form-control input-circle" placeholder="" name="description"></textarea>
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="文章来源" name="copyfrom">
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="file" class="form-control" name="thumb"> <span class="help-block m-b-none">请选择图片，图片尺寸： 750*402</span>
														</div>
													</div>
												</div>
