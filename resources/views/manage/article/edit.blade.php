											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="多个关键词之间用空格或者“,”隔开" name="keywords" required value="{{$data->keywords}}">
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="文章来源" name="copyfrom" value="{{$data->copyfrom}}">
														</div>
													</div>
													<div class="form-group">
