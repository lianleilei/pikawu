											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="友链名称" required="" name="name" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">网址</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="请填写http://开头的网址" name="url" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">网站联系人</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="网站联系人" name="username" required>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="input-group">
															<div class="icheck-inline">
																<label>
																<input type="radio" name="passed" class="icheck" data-radio="iradio_square-grey" value="1"> 是 </label>
																<label>
