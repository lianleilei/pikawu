...
<title>MyCMS内容管理系统</title>

<link href="/manage/static/css/login.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/manage/static/lib/jquery/1.9.1/jquery.min.js"></script> 
<script src="/manage/static/js/verificationNumbers.js" tppabs="/manage/static/js/verificationNumbers.js"></script>
<style>
...
<div class="login-box" id="demo">
   <div class="input-content">
     ...
     <form action="{{ url('/manage/doLogin') }}" method="POST"> 
     {{ csrf_field() }}
     <p class="p user_icon">
       <input type="text" name="name" placeholder="账号" autocomplete="off" class="login_txtbx">
     </p> 
     <p class="p pwd_icon">
...
<!--      <div class="p val_icon">
      ...
      <div class="signup">
          <input type="submit" value="登&nbsp;&nbsp;录" class="gv">
