											...
											{{ csrf_field() }} 
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="客户姓名 " required="" name="name">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">联系电话</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="联系电话" required="" name="phone">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">客户地址</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="客户地址，最好写小区名称"  name="address">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">维修项目</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="维修项目" required="" name="item">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">维修费用</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="维修费用" required="" name="price">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="input-group">
															<div class="icheck-inline">
																<label>
																<input type="radio" name="on_sale" class="icheck" data-radio="iradio_square-grey" value="1"> 是 </label>
																<label>
																<input type="radio" name="on_sale" class="icheck" data-radio="iradio_square-grey" value="0"> 否 </label>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="备注，可选"  name="description">
														</div>
													</div>
