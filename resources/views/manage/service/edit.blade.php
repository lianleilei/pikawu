								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="/manage/service/store" class="form-horizontal" method="post">
											{{ csrf_field() }} 
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="客户姓名 " required="" name="name" value="{{$data->name}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">联系电话</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="联系电话" name="phone" value="{{$data->phone}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">客户地址</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="客户地址，最好写小区名称"  name="address" value="{{$data->address}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">维修项目</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="维修项目" required="" name="item" value="{{$data->item}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">维修费用</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="维修费用" required="" name="price" value="{{$data->price}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">是否付款</label>
														<div class="input-group">
															<div class="icheck-inline">
																<label>
																<input type="radio" name="on_sale" class="icheck" data-radio="iradio_square-grey" value="1" {{$data->on_sale == 1?'checked':''}}> 是 </label>
																<label>
																<input type="radio" name="on_sale" class="icheck" data-radio="iradio_square-grey" value="0" {{$data->on_sale == 0?'checked':''}}> 否 </label>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="备注，可选"  name="description" value="{{$data->description}}">
														</div>
													</div>
