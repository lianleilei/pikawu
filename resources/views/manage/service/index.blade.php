		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="btn-group">
							<a href="/manage/service/create" class="btn green">
							新增记录 <i class="fa fa-plus"></i>
							</a>
						</div>
					</div>
					<div class="col-md-6">
						<div id="sample_1_filter" class="dataTables_filter">
						<form action="/manage/service" method="get">
							<label><input type="text" class="form-control input-small input-inline" placeholder="搜索客户名称" aria-controls="sample_1" name="search"><button type="submit" class="btn green">搜索</button></label>
						</form>
						</div>
					</div>
					<div class="col-md-12">
								...
								<div class="table-responsive">
									...
									<tbody>
										...
										<tr id="tr_{{$service->id}}">
											...
											<td>￥{{$service->price}}</td>
											<td>{{$service->on_sale == 1?'已付':'未付'}}</td>
											<td>{{$service->created_at}}</td>
											<td><a class="edit" href="/manage/service/edit/{{$service->id}}">
											修改 </a> | <a href="javascript:;" class="delete" onclick="del_service('{{$service->id}}')">
											删除 </a>
											</td>
										</tr>
										@endforeach
