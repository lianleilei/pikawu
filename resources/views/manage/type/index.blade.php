		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="btn-group">
							<a href="/manage/type/add" class="btn green">
							新增栏目 <i class="fa fa-plus"></i>
							</a>
						</div>
					</div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr class="odd gradeX" id="tr_{{$vo->id}}">
												<td>{{$vo->id}}</td>
												<td>{!! $nbsp[$k] !!}{{$vo->name}}</td>
												<td>
													<a href="/manage/type/display/{{$vo->id}}" class="btn btn-xs {{$vo->display == 1 ? 'green-meadow' : 'red-sunglo'}}">
													<i class="fa fa-share"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> {{$vo->display == 1 ? '已显示' : '显示'}} </font></font></a>
												</td>
				                                <td>
				                                	<a href="/manage/type/edit/{{$vo->id}}" class="btn default btn-xs purple">
														<i class="fa fa-edit"></i> 修改 </a>
				                                	@if($vo->pid == 0)
				                                	@else
				                                	<a href="javascript:;" class="btn default btn-xs black" onclick="delete_type('{{$vo->id}}')">
