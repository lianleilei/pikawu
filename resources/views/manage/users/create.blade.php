											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="用户名" required="" name="name" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">邮箱号</label>
														<div class="col-md-8">
															<input type="email" id="email" class="form-control input-circle" placeholder="请填写正确的邮箱号" name="email" required>
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="password" class="form-control input-circle" name="password" required>
														</div>
													</div>											
												</div>
