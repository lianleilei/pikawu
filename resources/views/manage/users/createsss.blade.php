								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="/manage/users/store" class="form-horizontal" method="post">
											{{ csrf_field() }}
												<input type="hidden" name="type" value="0">
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-2 control-label"><span style="color:red;">@if(session('msg')) {{session('msg')}} @endif</span></label>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="手机号" required="" name="phone">
														</div>
													</div><div class="form-group">
														<label class="col-md-2 control-label">地址</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="地址" name="address">
														</div>
													</div>													
												</div>
